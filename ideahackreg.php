...
<body>
    ...
    <section id="contact" class="section-with-bg wow fadeInUp">
      ...
      <div class="container">
        ...
        <div class="section-header">
          <h2>Idea Hackthon Team Registration</h2>
          <p>Gather your hacker team</p>
        </div>

        <div class="hack-selector mt-5 mb-5">
          <div class="forms-div mt-5" id="idea-reg-form-div">
            <?php require_once 'forms/ideahackform.php'; ?>
          </div>
        </div>
      </div>
    </section><!-- #contact -->
  ...
  <script src="process/ideahack.js"></script>
